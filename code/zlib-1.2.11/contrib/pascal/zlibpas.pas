...
type
  alloc_func = function(opaque: Pointer; items, mem_usage: Integer): Pointer;
                 cdecl;
  ...
  in_func    = function(opaque: Pointer; var buf: PByte): Integer;
                 cdecl;
  out_func   = function(opaque: Pointer; buf: PByte; mem_usage: Integer): Integer;
                 cdecl;
  ...
  z_stream = packed record
    ...
    adler: LongInt;       (* adler32 val of the uncompressed data *)
...
function deflatePrime(var strm: z_stream; bits, val: Integer): Integer;
...
function inflatePrime(var strm: z_stream; bits, val: Integer): Integer;
